...
| **Foundry DevPack · Single-tab install** | Interactive redesign combining the `winget` package install and DevPack setup in one terminal tab with azd-style progress. | [`foundry-devpack/`](./foundry-devpack/) · [live](https://hyoshis.github.io/cliux/prototypes/foundry-devpack/) |
